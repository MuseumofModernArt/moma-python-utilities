    ...
    def pg_source_query(begin, end):
        return f"""
            SELECT
                ...
                NULL AS login_cta,
                NULL AS login_prompt_copy,
                NULL AS login_features_copy,
                title,
                title_enabled::text,
                ...
                hero_image_url,
                non_refundable_copy,
                require_mailing_address::text,
                require_phone_number::text,
                reminder_email_enabled::text,
                to_char(created_at, 'YYYY-MM-DD HH24:MI:SS"."US') as created_at,
                to_char(updated_at, 'YYYY-MM-DD HH24:MI:SS"."US') as updated_at,
                price_list_id,
                event_type,
                allow_museum_admission::text,
